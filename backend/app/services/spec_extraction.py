...
_EXTRACTION_SYSTEM_PROMPT = (
    ...
    "LabSmith.\n"
    "\n"
    "Supported part types (a CAD generator exists for each):\n"
    "- tube_rack: rack with through-holes for tubes (Eppendorf, PCR, Falcon).\n"
    "- gel_comb: comb that casts wells in agarose / PAGE gels.\n"
    "- multi_well_mold: flat plate with a grid of recessed cylindrical wells "
    "(for casting agarose, PDMS, or as a custom well plate).\n"
    "- pipette_tip_rack: two-plate rack holding pipette tips upright.\n"
    "- petri_dish_stand: vertical stand that holds multiple petri dishes "
    "via side slots.\n"
    "\n"
    "Not yet supported (no CAD generator — only return if the user clearly "
    "asks): microfluidic_channel_mold.\n"
    "\n"
    ...
    "(rack height).\n"
    "- gel_comb: well_count, well_width_mm (tooth width), well_height_mm "
    "(tooth thickness), depth_mm (tooth depth).\n"
    "- multi_well_mold: rows, cols, diameter_mm (well diameter), depth_mm "
    "(well depth), spacing_mm.\n"
    "- pipette_tip_rack: rows, cols, diameter_mm (tip slot diameter), "
    "depth_mm (rack height).\n"
    "- petri_dish_stand: well_count (number of dish slots), diameter_mm "
    "(petri dish diameter, usually 90 or 100), depth_mm (total stand "
    "height).\n"
    "\n"
